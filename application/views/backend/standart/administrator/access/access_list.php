                        ...
                        <?php endforeach; ?>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?= site_url('administrator/group/add'); ?>">Tambahkan Role Baru</a></li>
                              <?php endif; ?>
                              <?php if ($this->aauth->is_allowed('group_list')): ?>
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?= site_url('administrator/group'); ?>">Lihat Semua Roles</a></li>
                              <?php endif; ?>
                            </ul>
                          </li>
