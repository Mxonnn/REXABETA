               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="Tambah Retur baru (Ctrl+A)" href="<?=  site_url('administrator/retur/add'); ?>"><i class="fa fa-plus-square-o" ></i> Tambah Retur Baru</a>
                        <?php }) ?>
