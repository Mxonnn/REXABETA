            ...
            <div class="box box-primary">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/disposal/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_disposal', 
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            ...
            text: "Data disposal yang akan diubah, akan tereset kembali.",
            type: "warning",
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/disposal';
            }
          });
      ...
      $('.btn_save').click(function(){
       ...
       $('#disposal_berkas_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + '/administrator/disposal/upload_berkas_file',
              params : params
          },
          deleteFile: {
              enabled: true, // defaults to false
              endpoint: BASE_URL + '/administrator/disposal/delete_berkas_file'
          },
          thumbnails: {
              placeholders: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/disposal/get_berkas_file/<?= $disposal->id_disposal; ?>',
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + '/administrator/disposal/delete_berkas_file/' + uuid);
              },
