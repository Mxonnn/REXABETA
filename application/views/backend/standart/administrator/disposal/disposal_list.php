...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function assets() {
       window.location.href = BASE_URL + '/administrator/Disposal/add';
       return false;
   });
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="Tambah Disposal baru (Ctrl+A)" href="<?=  site_url('administrator/disposal/add'); ?>"><i class="fa fa-plus-square-o" ></i> Tambah Disposal Baru</a>
                        <?php }) ?>
                        <?php is_allowed('disposal_export', function(){?>
                        <a class="btn btn-flat btn-success" title="Export Disposal dalam format XLS" href="<?= site_url('administrator/disposal/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export XLS</a>
                        <?php }) ?>
                        <?php is_allowed('disposal_export', function(){?>
                        <a class="btn btn-flat btn-success" title="Export Disposal dalam format PDF" href="<?= site_url('administrator/disposal/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_disposal" id="form_disposal" action="<?= base_url('administrator/disposal/index'); ?>">
                     ...
                     <?php foreach($disposals as $disposal): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/disposal/view/' . $disposal->id_disposal); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> Lihat
                              <?php }) ?>
                              <?php is_allowed('disposal_update', function($option_disposal) use ($disposal){?>
                              <a href="<?= site_url('administrator/disposal/edit/' . $disposal->id_disposal); ?>" class="label-default"><i class="fa fa-edit "></i> Edit</a>
                              <?php }) ?>
                              <?php is_allowed('disposal_delete', function($option_disposal) use ($disposal){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/disposal/delete/' . $disposal->id_disposal); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Hapus</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/disposal');?>" title="reset filter">
  ...
  $(document).ready(function(){
    ...
    $('.remove-data').click(function(){
      ...
      swal({
          ...
          text: "Disposal yang sudah dihapus, tidak dapat dikembalikan lagi!",
          type: "warning",
    ...
    $('#apply').click(function(){
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/administrator/disposal/delete?' + serialize_bulk;      
            }
          });
